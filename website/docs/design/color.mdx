...
<BigLink
  link="../libraries/color/colorInterfaceLibrary#primary-colors"
...
<BigLink
  link="../libraries/color/colorInterfaceLibrary#secondary-colors"
...
<BigLink
  link="../libraries/color/colorMapsChartsLibrary#qualitative-colors"
  label="Qualitative color palette"
/>
...
<BigLink
  link="../libraries/color/colorMapsChartsLibrary#sequential-colors"
  label="Sequential color palette"
/>
...
<BigLink
  link="../libraries/color/colorMapsChartsLibrary#divergent-colors"
  label="Divergent color palette"
/>
...
<BigLink
  link="../libraries/color/colorMapsChartsLibrary#label-colors"
