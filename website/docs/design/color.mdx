...
<BigLink to="/libraries/color/interface#primary-colors">Primary color palette</BigLink>
...
<BigLink to="/libraries/color/interface#secondary-colors">Secondary color palette</BigLink>
...
<BigLink to="/libraries/color/maps-charts/#qualitative-colors">Qualitative color palette</BigLink>
...
<BigLink to="/libraries/color/maps-charts#sequential-colors">Sequential color palette</BigLink>

### Divergent

When the numeric variable has a meaningful central value, like zero, then you can use the diverging palette.

<BigLink to="/libraries/color/maps-charts/#divergent-colors">Divergent color palette</BigLink>
...
<BigLink to="/libraries/color/maps-charts/#label-colors">Label color palette</BigLink>
