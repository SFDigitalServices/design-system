...
import { ColorSwatch, InlineSwatch, LibraryRow } from "@site/src/components";
...
[Primary color palette](../libraries/colorUiLibrary#primary-colors)
...
[Secondary color palette](../libraries/colorUiLibrary#secondary-colors)
...
[Qualitative color palette](../libraries/colorMapsChartsLibrary#qualitative-colors)
...
[Sequential color palette](../libraries/colorMapsChartsLibrary#sequential-colors)

### Divergent

When the numeric variable has a meaningful central value, like zero, then you can use the diverging palette.

[Divergent color palette](../libraries/colorMapsChartsLibrary#divergent-colors)

### Label colors

<p>
  Colors for use when labeling the charts and maps are the two listed. The
  darker of the two <InlineSwatch>{colors.black}</InlineSwatch> will be the
  primary color for use when display text, titles, labels, etc. Reserve the
  lighter color <InlineSwatch>{colors.text.secondary}</InlineSwatch> for
  secondary information.
</p>

[Label color palette](../libraries/colorMapsChartsLibrary#label-colors)
