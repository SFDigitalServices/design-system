...
import { designSystemPackage, designSystemVersion } from '@site/constants'
...
<div>Replace <code>{designSystemVersion}</code> in the above link <code>href</code> attributes with <code>latest</code> to get the latest version.</div>
