---
title: Using our icons
description: Using our icons on the web
tags: [icons]
---
...
Our icons are published as both a [package of SVG files](#) and a custom
element to display and style them on the web.

The simplest way to use our icons is with the `<sfgov-icon>` [custom
element], which is defined in our main [JavaScript bundle](./javascript/).
...
The [Icon Library](../libraries/iconsLibrary) lists valid values for the `symbol` attribute.
