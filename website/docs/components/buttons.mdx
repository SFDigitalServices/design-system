...
This is the most common type of button. Use these to direct people to a clear primary action. To call out that these buttons are actionable, they are action blue <InlineSwatch value={colors.action} />.
...
<img alt="" src="/static/images/button-specs.png" className="w-full" />
